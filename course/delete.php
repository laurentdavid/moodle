...
if (!async_helper::is_async_pending($id, 'course', 'backup')) {
    ...
    // In the following script, we need to use setTimeout as disabling the button directly
    // in the event listener script prevent the click to be taken into account.
    $jsscript = <<<EOF
