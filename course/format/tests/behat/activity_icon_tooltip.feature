...
Feature: Activity type tooltip.
  ...
  Scenario: Teacher can see the activity type tooltip only while editing.
    ...
    And I hover over the "Assignment icon" "core_courseformat > Activity icon" in the "Activity sample 1" "activity"
    And "body>.tooltip" "css_element" should not exist
    And I hover over the "Page icon" "core_courseformat > Activity icon" in the "Activity sample 2" "activity"
    And "body>.tooltip" "css_element" should not exist
    And I turn editing mode on
    When I hover over the "Assignment icon" "core_courseformat > Activity icon" in the "Activity sample 1" "activity"
