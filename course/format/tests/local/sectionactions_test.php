...
class sectionactions_test extends \advanced_testcase {
     ...
     * @param bool $skip the id of the delegated section
     * @param bool $expectgexception the fields to set on the section
     * @param int $expected the fields to set on the section
     */
    public function test_create(int $sectionnum, bool $skip, bool $expectgexception, int $expected): void {
        global $DB;
        $this->resetAfterTest();
     ...
     * @param array $sectionnums the name of the plugin
    ...
    /**
     * Test that triggering a course_section_created event works as expected.
     * @covers ::delete
     */
