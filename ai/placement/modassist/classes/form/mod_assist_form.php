 ...
 */
class mod_assist_form extends dynamic_form {
    ...
    public function process_dynamic_submission(): array {
        global $CFG;
        //$filepath = $this->save_file('additionalfiles');
    ...
    protected function get_page_url_for_dynamic_submission(): moodle_url {
        $cmid = $this->optional_param('cmid', null, PARAM_INT);
        return new moodle_url('/mod//preset.php', ['id' => $cmid]);
    }
    ...
    protected function definition() {
        $mform = $this->_form;
        $mform->addElement('html', \html_writer::div(get_string('instructions_desc', 'aiplacement_modassist'), 'py-3'));
        $mform->addElement('hidden', 'cmid');
        $mform->setType('cmid', PARAM_INT);

        //$mform->addElement('filepicker', 'additionalfiles', get_string('additionalfiles', 'aiplacement_modassist'), null,
