...
final class utils_test extends \advanced_testcase {
    ...
    public function test_is_course_assist_available(): void {
        ...
        assign_capability('aiplacement/modassist:summarise_text', CAP_PROHIBIT, $teacherrole->id, $context);
        $this->setUser($user2);
