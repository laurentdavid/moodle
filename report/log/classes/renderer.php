...
class report_log_renderer extends plugin_renderer_base {
    ...
    public function report_selector_form(report_log_renderable $reportlog) {
        ...
        if (empty($reportlog->currentcmid)) {
            ...
            echo html_writer::empty_tag('input', array('type' => 'hidden', 'name' => 'id', 'value' => $selectedcourseid));
        }
        ...
        if (empty($reportlog->currentcmid)) {
            ...
            echo html_writer::empty_tag('input', array('type' => 'hidden', 'name' => 'cmid', 'value' => $reportlog->currentcmid));
        }
