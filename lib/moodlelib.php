                    ...
                    if (function_exists($moddelete)) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                // Ignore weird or missing table problems or other issue here.
                                debugging("Defective module '$modname' error while deleting the $modname "
                                    . "entity with id $cm->modinstance: " . $e->getMessage());
                            }
