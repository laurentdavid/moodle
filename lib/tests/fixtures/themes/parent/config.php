...
/**
 * The configuration for theme_parent is defined here.
 *
 * @package     core
 * @copyright   2023 Your Name <you@moodle.com>
...
$THEME->layouts = [
    ...
    // Standard layout without main navbar and breadcrumbs : new layout.
    'standardnonavparent' => [
        'file' => 'drawers.php',
        'regions' => ['content', 'side-pre'],
        'defaultregion' => 'side-pre',
