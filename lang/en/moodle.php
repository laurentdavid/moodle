...
$string['maxnumberweeks_desc'] = 'The maximum value in the number of sections (and subsections if enabled) drop-down menu (applies to certain course formats only).';
