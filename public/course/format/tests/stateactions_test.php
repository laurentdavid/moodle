...
final class stateactions_test extends \advanced_testcase {
     ...
     *
     * @covers ::cm_move
     * @dataProvider cm_move_to_section_provider
     ...
     */
    public function test_cm_move_to_section(
        array $cmtomove,
        string $targetsection,
     ...
     * @return array the testing scenarios
     */
    public static function cm_move_to_section_provider(): array {
        return [
            ...
            'Move module into the same section' => [
                'cmtomove' => ['cm3'],
                'targetsection' => 'section3',
                'expectedcoursetree' => [
                    'section0' => ['cm0'],
     ...
     * @return array the testing scenarios
     */
    public static function cm_move_to_module_provider(): array {
        return [
            ...
            'Move module into a module that is in a subsection' => [
                'cmtomove' => ['cm1'],
                'targetmodule' => 'cm2',
                'expectedcoursetree' => [
                    'section0' => ['cm0'],
            ...
            'Move module before module in the same section (order kept as was already before)' => [
                'cmtomove' => ['cm3'],
                'targetmodule' => 'cm4',
                'expectedcoursetree' => [
                    'section0' => ['cm0'],
            ...
            'Move module before module in the same section' => [
                'cmtomove' => ['cm4'],
                'targetmodule' => 'cm3',
                'expectedcoursetree' => [
                    'section0' => ['cm0'],
