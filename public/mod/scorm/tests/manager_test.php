...
final class manager_test extends \advanced_testcase {
     ...
     * @dataProvider get_participant_count_data
     */
     ...
     * @return array
     */
    public static function get_participant_count_data(): array {
        return [
            ...
            'no groups' => [
                'groupmode' => NOGROUPS,
                'expected' => [
                    't1' => 4, // We count students and teachers because teachers can submit attempts.
                    't2' => 4,
                    's1' => 4,
                    's2' => 4,
                ],
